...
app.post('/api/ai/augment', async (req, res) => {
  try {
...
app.post('/api/ai/aspects', async (req, res) => {
  try {
    const { symbol, stockName, industry, force } = req.body || {};
    if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL', message: '缺少股票代码' });
...
app.get('/api/ai/augment/:symbol', (req, res) => {
...
app.get('/api/ai/aspects/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.post('/api/ai/products', async (req, res) => {
  try {
...
app.get('/api/ai/products/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.get('/api/ai/company/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.post('/api/ai/supply', async (req, res) => {
  try {
    const { symbol, stockName, industry, force, companyName } = req.body || {};
    if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL', message: '缺少股票代码' });
...
app.get('/api/ai/supply/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.post('/api/ai/holders', async (req, res) => {
  try {
...
app.get('/api/ai/holders/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.get('/api/ai/research/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.post('/api/ai/announcements', async (req, res) => {
  try {
    const { symbol, stockName, industry, force } = req.body || {};
    if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL', message: '缺少股票代码' });
...
app.get('/api/ai/announcements/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.post('/api/ai/prefetch-facts', async (req, res) => {
  try {
...
app.post('/api/ai/earnings', async (req, res) => {
  try {
    const { symbol, stockName, industry, force } = req.body || {};
    if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL', message: '缺少股票代码' });
...
app.get('/api/ai/earnings/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.get('/api/miaoxiang/auth', async (req, res) => {
  try {
...
app.get('/api/miaoxiang/auth/status', async (req, res) => {
  try {
...
app.post('/api/miaoxiang/data', async (req, res) => {
  try {
...
// 资讯 / 研报 / 公告聚合
app.post('/api/miaoxiang/news', async (req, res) => {
  try {
    const { query } = req.body || {};
    if (!query || !query.trim()) return res.status(400).json({ error: 'NO_QUERY', message: '缺少查询语句' });
...
app.post('/api/miaoxiang/apikey', async (req, res) => {
  try {
...
app.post('/api/ai/industry-index', async (req, res) => {
  try {
...
app.get('/api/ai/industry-index/:symbol', (req, res) => {
  const symbol = String(req.params.symbol || '').trim();
  if (!symbol) return res.status(400).json({ success: false, error: 'NO_SYMBOL' });
...
app.get('/api/industry-index-history/:symbol', async (req, res) => {
  try {
    const symbol = String(req.params.symbol || '').trim();
...
app.get('/api/ai/img/:file', (req, res) => {
  try {
...
app.post('/api/docs/classify', async (req, res) => {
  try {
...
app.post('/api/docs/upload', upload.array('files', 100), async (req, res) => {
  try {
...
// 获取公司文档列表
app.get('/api/docs/company/:stockCode', (req, res) => {
  try {
...
// 列出所有公司
app.get('/api/docs/companies', (req, res) => {
  try {
...
// 下载/查看文档
app.get('/api/docs/download/:docId', (req, res) => {
  try {
...
// 获取文档类型列表
app.get('/api/docs/types', (req, res) => {
...
app.post('/api/docs/sync-report', async (req, res) => {
  try {
...
app.get('/api/docs/sync-status/:symbol', (req, res) => {
  try {
