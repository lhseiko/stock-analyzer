...
//   大盘 0.3071 | 资金量能 0.1783 | 对标期货 0.0971 | 增持减持 0.0485
//   行业板块 0.0801 | 科技指数 0.0632 | 个股短期动向 0.2257
const W_SENTIMENT = 0.3071;
const W_CAPITAL = 0.1783;
const W_FUTURES = 0.0971;
const W_HOLDINGS = 0.0485;
