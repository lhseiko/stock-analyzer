...
const LAYOUT_VERSION = '20260911d'; // 展示布局/口径调整时手动 +1；因子结构变化由哈希自动捕获（20260911d：事件驱动因子「原油冲击」参考对象由布伦特原油期货改为原油主连(INE·scm主连)——因子名/文案变更，升版强制重算旧记录以刷新事件因子卡片；20260911c：新增该子因子）
