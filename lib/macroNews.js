...
// 20260917l：此前误写成 _localDate() 但本文件只导入了 localDate（无别名）→ 每次调用都抛
// ReferenceError: _localDate is not defined，服务日志刷屏「Macro news error」，首页宏观卡片长期取不到数据。
function localToday() { return localDate(); }
