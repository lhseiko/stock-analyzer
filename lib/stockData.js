...
async function getMarketOverview() {
  ...
  return {
    ...
    sectorDataDate: panel.sectorDataDate || panel.sectorDate,  // 数据中心通道的数据日期（收盘口径），供面板如实标注是否盘中不更新
    sectorChannel: panel.sectorChannel,                        // 'push2'(实时 tick) | 'datacenter'(收盘口径) | 其他源
