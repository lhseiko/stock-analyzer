...
function generateConclusion(dcf, valuation, growth, cashFlowData, revenueCostData, balanceAnalysis, auditOpinion, shareholders, companyType, dividends, quote, insuranceAnalysis) {
  ...
  if (validRatings.length > 0) {
    ...
    let conclusionText = generateConclusionText(overallRating, currentPrice, dcf, valuation, growth, cashFlowData, revenueCostData, auditOpinion, validRatings, companyType, dividends, quote, insuranceAnalysis, fairValueCenter, fairValueRange);

    // ===== 个股专属估值模型（20260908）：目前仅中国平安 601318 启用，其他标的完全走上面的通用逻辑 =====
